...
- `List(userID uuid.UUID, params ListParams) ([]models.Notification, int64, error)`
- `MarkAsRead(id, userID uuid.UUID) error`
- `MarkAllAsRead(userID uuid.UUID) (int64, error)`
...
Implements business logic for all notification operations.
